  ...
  urls.forEach((url) => {
      ...
      script.addEventListener('load', () => {
        ...
        if (!urls.some(u => !u.done)) {
            ...
            function gtfo() {
                window.$( "span:contains('Suggested for you')" ).parent().parent().parent().parent().parent().parent().parent().parent().css('height', '0px');
                window.$( "span:contains('Sponsored')" ).parent().parent().parent().parent().parent().parent().parent().parent().css('height', '0px');
            }
